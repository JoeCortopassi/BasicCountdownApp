...
- (int) addNewCountdown:(ObjectCountdown *)newCountdown
{
    __block int lastId;
    [self.databaseQueue inDatabase:^(FMDatabase *db) {
        [db executeUpdate:@"INSERT INTO countdown VALUES (0, ?, ?, ?)", [HelperDate getStringFromDate:newCountdown.dateOfEvent withFormat:standardDateFormat], newCountdown.imageBackgroundFileName, newCountdown.title];
